...
#pragma config(Motor,  port5,           leftMotor3,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           leftMotor4,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           rightMotor3,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           rightMotor4,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           intakeMotor,   tmotorVex393_MC29, openLoop)
